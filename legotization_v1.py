...
def main():
    ...
    verificar_y_crear_ruta('./data/intermediate')

    desired_crs = 'EPSG:32718'

    gdfs = load_data()
    gdfs = check_crs_data(gdfs=gdfs, desired_crs=desired_crs)
    edificaciones_gdf, curvas_nivel_gdf, unit, poligono = unpack_data(gdfs=gdfs, time='actual')
    ...
    # print('7.- Haciendo el mesh (si solo querias el shape puedes hacerle ctrl+c ahora)')
    # meshes = []
